...
import Lazy from "@/components/LuxuryPage/Lazy";

export type LuxuryVideoProps = SliceComponentProps<Content.LuxuryVideoSlice>;

const LuxuryVideo: FC<LuxuryVideoProps> = ({ slice }) => {
  return (
    <section
